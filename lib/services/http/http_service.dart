...
class HttpService {
  ...
  Future<T> get<T>(String path,
    ...
    return request('get', path, params: params, contentType: contentType);
  }

  Future<T> post<T>(String path,
      {Map<String, Object?>? params, HttpContentType? contentType}) async {
    return request('post', path, params: params, contentType: contentType);
  }

  Future<T> put<T>(String path,
      {Map<String, Object?>? params, HttpContentType? contentType}) async {
    return request('put', path, params: params, contentType: contentType);
  }

  Future<T> delete<T>(String path,
      {Map<String, Object?>? params, HttpContentType? contentType}) async {
    return request('delete', path, params: params, contentType: contentType);
  }
